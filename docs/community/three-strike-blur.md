...
이 페이지는 TripTogether 커뮤니티 도메인의 신고 처리 정책 중 하나를 다룬다. 같은 신고 흐름의 다른 측면은 [신고 도메인](/report/)과 [커뮤니티 도메인](/community/)에서 함께 본다. 전체 그림은 [도메인 전체 개요](/domains), [담당별 보기](/by-area/), [전체 흐름](/flow/)에서 확인한다.
